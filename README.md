...
@TODO: Should change to support new prebuild database trough ``./populate_database.sh --data-dir /metadome_prebuild_dir --file MetaDome_Gencodev45-PFAM37.4-Uniprot2025_metapositions.csv.gz``
