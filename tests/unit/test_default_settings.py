...
COVERED_SETTINGS = {
    ...
    "METADOMAIN_SNV_ANNOTATION_FILE_NAME_PER_SOURCE",
    "METADOMAIN_CACHE_MAXSIZE",
    ...
    "PREBUILD_PRINT_LIST_EXAMPLES_CAP",
    "PFAM_DIR",
    "PFAM_ALIGNMENT_DIR",
    "PFAM_HMM_DAT",
    "PFAM_HMM",
...
class TestDefaultSettings(unittest.TestCase):
    ...
    def test_file_name_settings(self):
        ...
        for source, file_name in settings.METADOMAIN_SNV_ANNOTATION_FILE_NAME_PER_SOURCE.items():
            _assert_non_empty_string(self, file_name, f"METADOMAIN_SNV_ANNOTATION_FILE_NAME_PER_SOURCE[{source}]")
            self.assertNotIn("/", file_name, f"{source} annotation file name should not be a full path")
